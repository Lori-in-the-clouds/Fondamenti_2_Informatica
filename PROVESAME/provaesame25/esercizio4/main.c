...
int main(void) {
    ...
    t = TreeCreateRoot(
        e+1,
        TreeCreateRoot(e+2,TreeCreateRoot(e+4,NULL,NULL), TreeCreateRoot(e + 5, NULL, NULL)),
        TreeCreateRoot(e+3,TreeCreateRoot(e+6,NULL,TreeCreateRoot(e+8,NULL,NULL)), TreeCreateRoot(e + 7, NULL, NULL))
    );
    ElemType c = 8;
    ElemType s = 7;
    Node* n1 = TreeCreateRoot(&c, NULL, NULL);
    Node* n2 = TreeCreateRoot(&s, NULL, NULL);
    Node *ris = LowestCommonAncestor(t, n1, n2);
}
 /*    1
      /  \
     /    \
